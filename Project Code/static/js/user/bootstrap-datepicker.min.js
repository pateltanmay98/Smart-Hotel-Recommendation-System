    ...
    k.prototype = {
        ...
        update: function() {
            ...
            return (
                ...
                d &&
                (this._trigger("changeDate"), this.element.change()), !this.dates.length &&
                b.length &&
        ...
        fillDow: function() {
            if (this.o.showWeekDays) {
                var b = this.o.weekStart,
                    c = "<tr>";
                for (
                    this.o.calendarWeeks && (c += '<th class="cw">&#160;</th>'); b < this.o.weekStart + 7;
        ...
        fillMonths: function() {
            for (
                var a, b = this._utc_to_local(this.viewDate), c = "", d = 0; d < 12; d++
            )
        ...
        r = {
            ...
            parseDate: function(c, e, f, g) {
                ...
                if (
                    ...
                    for (
                        j = c.match(/([\-+]\d+)([dmwy])/gi), c = new Date(), n = 0; n < j.length; n++
                    )
            ...
            formatDate: function(b, c, d) {
                ...
                (b = []);
                for (
                    var f = a.extend([], c.separators), g = 0, h = c.parts.length; g <= h; g++
                )
